    ...
    <section id="skills" className="py-28 px-6 sm:px-10">
      <div className="max-w-7xl mx-auto">
        <motion.div className="flex items-center gap-3 mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <span className="text-sm font-mono font-bold text-stone-700 tracking-widest uppercase">03</span>
        </motion.div>
        ...
        <motion.p className="text-stone-700 text-sm mb-14 max-w-md" initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}>
